...
| 2 | **Đặng Quang Huy** | 2A202602962 | Pipeline & Retrieval Engineer & Frontend Engineer| `quanghuy` | - Recursive chunking & Vector DB Chroma (Task 4)<br>- Semantic Search, BM25 & RRF Reranking (Task 5, 6, 7)<br>- Fallback & Retrieval Pipeline (Task 8, 9)<br>- Generation có Citation & Safe Refusal (Task 10) <br>- Phát triển giao diện Chatbot Streamlit (`app.py`)<br>- Hiển thị trích dẫn nguồn, điểm tương đồng & tham số |
| 3 | **Ngô Hoàng Thụy Khuê** | 2A202603017 |  & Data Curator | `khue` | - Thu thập & làm giàu dữ liệu tin tức tuyển sinh (Task 1, 2, 3) |
